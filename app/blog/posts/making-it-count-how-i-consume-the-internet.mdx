...
> **Consuming more than you create** Effective people tend to create a lot of content. Content can mean a lot of things - but the rule is always the same, create more than you consume. Ineffective people, on the other hand, spend the majority of their time consuming the fruits of others' labor. They are consummate lurkers.I've seen this to be true as I've decrease consumption and focused on the important work in front of me.

[^1]: You can read more about the series and view links to additional posts [here](https://ericdodds.com/series-making-it-count/).



[^2]: You can read my post about being to busy [here](https://ericdodds.com/too-busy-cop-out-excuse/).



[^3]: You can read my post about distraction being a good thing [here](https://ericdodds.com/distraction-a-good-thing/).



[^4]: You can read my post about distraction [here](https://ericdodds.com/making-it-count-distraction-is-the-enemy/).



[^5]: You can read my post about the apps on my iPhone [here](https://ericdodds.com/what-apps-on-iphone/).
