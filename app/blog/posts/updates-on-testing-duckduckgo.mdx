...
[^1]: You can read the original article about un-tailored search [here](https://ericdodds.com/testing-un-tailored-search-duck-duck-go/).
...
[^3]: You can read the original article about the internet as an echo chamber [here](https://ericdodds.com/the-internet-as-a-giant-echo-chamber-for-individuals/).
