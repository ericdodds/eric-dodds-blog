...
function NotesListFallback() {
  return (
    <div className="flex flex-col gap-8" aria-hidden>
      {[0, 1, 2].map((i) => (
        <div key={i} className="border-b border-neutral-200 dark:border-neutral-800 pb-8 last:border-0 animate-pulse">
          <div className="h-5 w-2/3 rounded bg-neutral-200 dark:bg-neutral-800 mb-2" />
          <div className="h-4 w-24 rounded bg-neutral-200 dark:bg-neutral-800 mb-4" />
          <div className="h-4 w-full rounded bg-neutral-200 dark:bg-neutral-800 mb-2" />
      ...
      <div className="text-neutral-600 dark:text-neutral-400 space-y-3 text-sm">
        ...
        {process.env.NODE_ENV === 'production' ? (
          <p className="text-xs text-neutral-500 dark:text-neutral-500">
            After <code className="text-xs">next build</code>, new issues appear when the cache refreshes
            (up to about an hour) or when your GitHub webhook calls{' '}
