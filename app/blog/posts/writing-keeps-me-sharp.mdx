...
[^1]: You can read one of my previous articles about the relationship between quality and quantity, titled <em>Productivity Requires Producing More than You Consume</em>, [here](https://ericdodds.com/solving-scale-hard-every-size/).
