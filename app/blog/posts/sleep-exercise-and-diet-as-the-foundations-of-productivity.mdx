...
-   A new study found that engaging in a physical exercise regimen helps healthy aging adults improve their memory, brain health and physical fitness..."Physical exercise may be one of the most beneficial and cost-effective therapies widely available to everyone to elevate memory performance," Chapman said. "These findings should motivate adults of all ages to start exercising aerobically.”[^9]
-   And they recommend regular aerobic exercise to stave off mild cognitive decline, which is especially important, given the mounting evidence showing that regular exercise is good for cognitive function and overall brain health, and the rising toll of dementia.[^10]
-   A new analysis by University of Georgia researchers finds overwhelming evidence that regular exercise plays a significant role in increasing energy levels and reducing fatigue.[^11]
...
[^1]: See all posts in the Productivity Hacking series [here](/blog/productivity-hacking-introduction).

[^2]: You can read the original post about sleep, exercise and diet [here](/blog/making-it-count-sleep-exercise-and-diet-as-the-foundations-of-energy).

[^3]: Read my first mention of unsustainable habits in the post titled, *Productivity is Not Intuitive*, [here](/blog/productivity-hacking-is-not-intuitive).
...
[^7]: You can read more about how sleep affects health and work absenteeism [on ScienceDaily](http://www.sciencedaily.com/releases/2014/09/140903163633.htm).

[^8]: You can read more about recommended sleep quantities [on ScienceDaily](http://www.sciencedaily.com/releases/2015/02/150211132111.htm).

[^9]: You can read more about how exercise improves memory [on ScienceDaily](http://www.sciencedaily.com/releases/2013/11/131112105024.htm).

[^10]: You can read more about how aerobic exercise staves off cognitive decline [on ScienceDaily](http://www.sciencedaily.com/releases/2014/04/140408213545.htm).

[^11]: You can read more about how exercise increases energy levels [on ScienceDaily](http://www.sciencedaily.com/releases/2006/11/061101151005.htm).

[^12]: You can read more about how diet affects the brain [on PsychCentral's website](http://psychcentral.com/news/2008/07/10/healthy-food-can-improve-mental-health/2587.html).

[^13]: You can read more about the International Labor Organization's position on diet and nutrition [on their website](http://www.ilo.org/safework/areasofwork/WCMS_118393/lang--en/index.htm).
