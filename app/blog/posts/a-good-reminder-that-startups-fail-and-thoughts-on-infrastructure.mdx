...
[^2]: You can read about US Census data on business failure [in The New York Times](https://archive.nytimes.com/boss.blogs.nytimes.com/2009/07/15/failure-is-a-constant-in-entrepreneurship/) (archived; original link no longer available).
