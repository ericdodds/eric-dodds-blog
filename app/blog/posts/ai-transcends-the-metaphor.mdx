...
AutoGPT[^5] is an early example of running AI on loop, which is the basic architecture of an agent. 
...
[^3]: You can read Ethan Mollick’s article, _Onboarding your AI intern_, [on Substack](https://www.oneusefulthing.org/p/on-boarding-your-ai-intern). 
