...
> There's no question here of how ephemeral social media forums affect young people, simply a mandate that businesses be there.
...
[^3]: I wrote a post called *Threads of Belief, Questions and Answers* that addresses this topic in the context of world views. You can read the full post [here](/blog/making-it-count-threads-of-belief-questions-and-answers).
