...
*You can receive updates from this series via email by signing up to [this MailChimp list](http://eepurl.com/bgWldj).*
...
[^2]: I called out 'snake-oil' productivity advice in the [introduction to my Making it Count series](https://ericdodds.com/making-it-count-introduction/).
...
[^4]: You can read about my Making it Count articles [here](https://ericdodds.com/series-making-it-count/).
