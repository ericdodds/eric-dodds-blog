...
[^1]: You can read my brief article about the ubiquity of the web [here](https://ericdodds.com/inevitable-ubiquity-web/).
...
[^3]: You can read my post about stewarding time, attention and technology [here](https://ericdodds.com/making-it-count-steward-time-attention-technology/)
