...
summary: 'This is the fourteenth post in a series on productivity[^1]. The articles are based on content from a workshop I led at The Makers Summit. I can think of several times in my life where I've purchas...'
...
Productivity tools can be extremely helpful. I use a variety of systems everyday at home and work to stay organized and move work forward. The problem with tools isn't their potential utility. In fact, there isn't a problem with the tools at all—it's us. We often believe the fallacy that an external tool will somehow help us shortcut the time and hard work it takes to do anything well. 

Finding the 'perfect' task management system won't make you more productive anymore than a new pair of shoes will get you in shape. You're not going to be in great shape unless you find the desire inside of you to improve your fitness. Mann calls this phenomenon our tendency to see "tools as panaceas for our productivity and time-management problems."
...
[^3]: You can read the sixth post in this series, *First, know thyself*, [here](/blog/first-know-thyself).
