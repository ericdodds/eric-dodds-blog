...
summary: 'Today Peter and I had the chance to spend time with both leadership and various other teams from Zappos and MailChimp (if you are interested in using something like Mailchimp then you can check out...'
categories: ['Work']
