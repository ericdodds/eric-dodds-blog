...
As I said in my last post, research shows that while interrupted work is often picked back up the same day, the average amount of time it takes to get back on track is **23 minutes and 15 seconds**[^4].
