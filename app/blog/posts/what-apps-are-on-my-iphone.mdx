...
Last week I wrote a long post about how I attempt to steward my time, attention and technology[^1]. In that article I mentioned that I intentionally removed social applications from my iPhone and set up barriers that made doing things like surfing the web or browsing the internet a bit more difficult than just tapping on a icon.
...
[^1]: You can read the full article [here](/blog/making-it-count-distraction-is-the-enemy).
