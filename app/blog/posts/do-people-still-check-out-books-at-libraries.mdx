...
[^1]: You can read my first post about bookless libraries [here](/blog/bookless-libraries-and-the-democratization-of-information) and my second post about consumption VS creation in libraries [here](/blog/libraries-from-consume-to-create).
